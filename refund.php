...
<body>
  ...
  <!----------- SIDEBAR ------------>
    ...
    <div class="main_div">
        ...
        <div class="box">
                <br>
                <b style="font-family:sans-serif;">All REFUND PAYMENTS</b>
                <br><br><br>
                <table class="table">
                    <tr>
                    ...
                    <?php
                    $sql = "select * from payment where method='refund'";
                    ...
                    ?>
                        ...
                        <td class="border1 bo2"><?php echo $roww["no"]; ?></td>
                            ...
                            <td class="border1 bo2">   
                                <a href="delete_refund.php?id=<?php echo $roww['id']; ?>" class="btne">Refund payment</a>
                            </td>
                        </tr>
                    <?php
                    }
